...
<div class="col-4 my-4">
	<!-- 페이지 링크 -->
	<a href="/restaurant/stanby?currentPageNo=1&userNo=${sessionScope.user.no}" class="mx-2">&lt;&lt;</a>
	<c:if test="${pagination.currentPageNo > 1 }">
		<a href="/restaurant/stanby?currentPageNo=${pagination.currentPageNo - 1 }&userNo=${sessionScope.user.no}" class="mx-2">&lt;</a>
	</c:if>
	<!-- 디자이너가 작업할 수 있도록 조치함 -->
	...
	<c:forEach begin="${pagination.firstPageNoOnPageList }" end="${pagination.lastPageNoOnPageList }" var="pageNo">
		<a href="/restaurant/stanby?currentPageNo=${pageNo }&userNo=${sessionScope.user.no}" class="mx-3">${pageNo }</a>	
	</c:forEach>
	...
	<c:if test="${pagination.currentPageNo >= pagination.totalPageCount }&userNo=${sessionScope.user.no}">
		<a href="#" class="mx-2">&gt;</a>
	</c:if>
	
	<a href="/restaurant/stanby?currentPageNo=${pagination.totalPageCount }&userNo=${sessionScope.user.no}" class="mx-2">&gt;&gt;</a>
</div>
