			...
			<div class="container px-4 px-lg-5">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="/restaurant/stanby?userNo=${sessionScope.user.no }" data-value="${sessionScope.user.no }" id="stanbyRestaurant">입점 대기</a>
						</li>
