...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	<jsp:param value="카테고리별 음식점 리스트" name="title"/>
	<jsp:param value="오저치고?" name="center"/>
	<jsp:param value="카테고리 분류 : 밥, 국/찌개, 면/분식, 야식" name="content"/>
</jsp:include>
<section class="py-2">
	<div class="container px-4 px-lg-5 mt-3">
		<div class="row gx-4 gx-lg-4 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
			<c:forEach var="rst" items="${categoryInfo}">
